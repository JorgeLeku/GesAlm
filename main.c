...
// Falta la base de datos por lo cual el programa no funcionara. Primero el array guardado se creara pensando en el tama�o del almacen, es decir la empresa nos ha dado la cantidad de estanterias que contiene el almacen, estas estanterias tendran todas el mismo tamanyo y tendran tres pisos
...
//p1
	...
	printf("4. Administraci�n \n");

	scanf("%i", &menu);

	if(menu == 1){
		printf("Elige la categor�a del lote que busca: \n");
		...
		case 1: printf("�Que tipo de olla busca? \n");
				...
				default: printf("El numero introducido no corresponde a ning�n tipo \n");
	...
	if(menu == 2){
		printf("Elige la categor�a del lote que desea almacenar: \n");
		printf("1. OLLAS \n");
		printf("2. SARTENES \n");
		printf("3. MOLDES \n");
		printf("4. PINZAS \n");
		...
		switch(categoria){
		case 1: printf("Las ollas se almacenan en la estanter�a A, para m�s precisi�n indique el tipo de olla \n");
				printf("1. MASTER \n");
				printf("2. CHEF \n");
				printf("3. CHEF LUXE \n");
				printf("4. ROBUST \n");
		...
		break;
		case 2: printf("Las sartenes se almacenan en la estanter�a B, para m�s precisi�n indique el tipo de sarten \n");
				printf("1. TRIMETAL \n");
				printf("2. CHEF INOX \n");
				printf("3. CHEF TRICAPA \n");
				printf("4. ROBUST \n");
		...
		break;
		case 3: printf("Los moldes se almacenan en la estanter�a C, para m�s precisi�n indique el tipo de molde \n");
				printf("1. ALUMINIO \n");
				printf("2. ACERO \n");
				printf("3. SILICONA \n");
				printf("4. BOMBOM POLYSTYRENO \n");
		...
		break;
		case 4: printf("Las pinzas se almacenan en la estanter�a D, para m�s precisi�n indique el tipo de pinzas \n");
				printf("1. HIELO \n");
				printf("2. REPOSTERIA \n");
				printf("3. ENSALADA \n");
				printf("4. MADERA \n");
		...
		break;
		case 5: printf("Los objetos de higiene se almacenan en la estanter�a E, para m�s precisi�n indique el tipo de objeto de higiene \n");
				printf("1. INDICADORES INOX \n");
				printf("2. CENICERO \n");
				printf("3. SECADOR \n");
				scanf("%i", &tipo);
		...
		break;
		case 6: printf("Las baterias de cocina se almacenan en la estanter�a F, para m�s precisi�n indique el tipo de bateria de cocina \n");
				printf("1. STILO \n");
				printf("2. FOODIE \n");
				printf("3. ANODIZED \n");
				printf("4. FORTE \n");
		...
		break;
		case 7: printf("Las paelleras se almacenan en la estanter�a G, para m�s precisi�n indique el tipo de paellera \n");
				printf("1. ACERO \n");
				printf("2. CHEF INOX \n");
				printf("3. VALENCIANAS \n");
				printf("4. ESMALTADO \n");
		...
		break;
		case 8: printf("Los cuchillos se almacenan en la estanter�a H, para m�s precisi�n indique el tipo de cuchillo \n");
				printf("1. FORJADOS \n");
				printf("2. CERAMICOS \n");
				printf("3. ZIRCONIA \n");
				scanf("%i", &tipo);
		...
		break;
		case 9: printf("Los cubiertos se almacenan en la estanter�a I, para m�s precisi�n indique el tipo de cubierto \n");
				printf("1. CUBERTERIA HOTEL \n");
				printf("2.CUBERTERIA ARIES \n");
				scanf("%i", &tipo);
				switch(tipo){
		...
		break;
		case 10:printf("Las cafeteras se almacenan en la estanter�a G, para m�s precisi�n indique el tipo de cafetera \n");
				printf("1. CLASSIC \n");
				printf("2. LUXE \n");
				printf("3. ZENIT \n");
				scanf("%i", &tipo);
	...
	if(menu == 3){
		printf("Elige la categor�a del lote que desea vender: \n");
		printf("1. OLLAS \n");
		printf("2. SARTENES \n");
		printf("3. MOLDES \n");
		printf("4. PINZAS \n");
	...
	if(menu == 4){
		printf("Hola gerente, introduzca su contrase�a: \n");
	}
